...
var delay = audioContext.createDelay(0.2);   // max delay time is 0.1 seconds
...
freqSlider.addEventListener('input', function() 
{
  ...
  var newTime = this.value * this.value * 0.05;
  //moogFilter.setFreq(newFreq);  
  delay.delayTime.value = newTime;
  console.log ("delay time (milliseconds): ", newTime*5000);
}, "false");
